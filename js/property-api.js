...
function renderProperties(properties) {
  ...
  properties.forEach((property, index) => {  // index 파라미터 추가
    ...
    propertyCard.dataset.recordId = recordId; // recordId 데이터 속성으로 저장
...
function showPropertyDetails(property, recordId, index) {  // index 파라미터 추가
